class AppSizes {
  ...
  // Fine-grained spacing — exact values used across existing layouts so the
  // design can be tokenized without altering its appearance.
  ...
  static const double fontDisplayLg = 34.0;
