...
class _$TransactionEntityImpl implements _TransactionEntity {
  ...
  @override
  String toString() {
    return 'TransactionEntity(id: $id, amount: $amount, description: $description, category: $category, date: $date, isIncome: $isIncome)';
  }
...
abstract class _TransactionEntity implements TransactionEntity {
  const factory _TransactionEntity(
      ...
      final bool isIncome}) = _$TransactionEntityImpl;
